defmodule ConnectFourBackend.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(ConnectFour, [nil], [function: :start])
    ...
    opts = [strategy: :one_for_one, name: ConnectFourBackend.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ConnectFourBackendWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
